...
def porcentaje_de_aprobados_totales(lista):
    contador = 0
    for estudiante in lista:
        if estudiante.aprobado() == 'aprobado':
            contador += 1

    return round((contador / len(lista)*100), 2)
...
print(porcentaje_de_aprobados_totales(estud))
